...
Built with React and SASS. This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
...
This creates a mock api/database to test the application.  Changes and additions will not persist.
